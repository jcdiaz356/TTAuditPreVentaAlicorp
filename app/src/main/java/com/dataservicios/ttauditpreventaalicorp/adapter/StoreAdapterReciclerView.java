...
import com.dataservicios.ttauditpreventaalicorp.view.StoreAuditActivity;
...
public class StoreAdapterReciclerView extends RecyclerView.Adapter<StoreAdapterReciclerView.StoreViewHolder>  {
    ...
    public void onBindViewHolder(StoreViewHolder holder, int position) {
        ...
        holder.tvUbigeo.setText(String.valueOf(store.getRegion()));
...
//
    public class StoreViewHolder extends RecyclerView.ViewHolder {
        ...
        public StoreViewHolder(View itemView) {
            ...
            tvUbigeo        = (TextView)    itemView.findViewById(R.id.tvUbigeo);
