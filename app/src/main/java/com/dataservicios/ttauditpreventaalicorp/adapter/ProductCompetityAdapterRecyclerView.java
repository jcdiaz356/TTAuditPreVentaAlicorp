...
import com.dataservicios.ttauditpreventaalicorp.view.PollActivity;
...
public class ProductCompetityAdapterRecyclerView extends RecyclerView.Adapter<ProductCompetityAdapterRecyclerView.ProductViewHolder> {
    ...
    public ProductCompetityAdapterRecyclerView(ArrayList<Product> products, int resource, Activity activity, int store_id, int audit_id) {
